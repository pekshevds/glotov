...
def send_sms(subject: str, message: str, recipient_list: dict) -> None:
    pass


def send_mail(subject: str, message: str, recipient_list: dict) -> None:
    send_mail_from_django(
        subject=subject, message=message, from_email=None, recipient_list=recipient_list
    )


def transport_function() -> Callable | None:
    choices = {
...
def send_pin_code(pin_code: str, recipient: str) -> None:
